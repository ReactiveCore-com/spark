...
private[spark] class NettyBlockTransferService(
    ...
    bindAddress: String, // RC changes
    override val hostName: String,
    _port: Int, // RC changes
    numCores: Int)
...
//      val server = transportContext.createServer(hostName, port, bootstraps.asJava) // RC changes
      val server = transportContext.createServer(bindAddress, port, bootstraps.asJava) // RC changes
